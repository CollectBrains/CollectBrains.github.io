...
$(function(){$(".toggle-button").click(function(){return $(this).toggleClass("on"),$(".main-mnu").slideToggle(),!1}),$(".portfolio-item").magnificPopup({type:"image",closeOnContentClick:!0,image:{verticalFit:!1}}),$(".quotes").owlCarousel({loop:!0,nav:!0,smartSpeed:700,responsiveClass:!0,dots:!0,items:1,navText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>']});var e=new Slideout({panel:document.getElementById("panel"),menu:document.getElementById("menu"),padding:256,tolerance:70,easing:"cubic-bezier(.32,2,.55,.27)"});$(".toggle-button").on("click",function(){e.toggle()}),$(".mobile-mnu a").on("click",function(){$(".toggle-button").removeClass("on"),e.close()})});